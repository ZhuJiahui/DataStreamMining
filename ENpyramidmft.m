...
write_directory1 = 'dataset/mft/Music5/5/data';
write_directory2 = 'dataset/mft/Music5/5/phst';
write_directory3 = 'dataset/mft/Music5/5/original_index';
write_directory4 = 'dataset/mft/Music5/5/entropy';
...
if file_number < 2
    ...
    for i = 1 : length(compress_index)
        ...
        for j = 1 : length(compress_index{i})
            ...
            %original_count = original_count + size(sample_data, 1) * size(sample_data, 2);
        ...
        compress_count = compress_count + size(data_level_result, 1) * size(data_level_result, 2);
        % 将该层的所有数据的时间信息等写入文件
...
% 金字塔压缩索引
write_filename = 'dataset/mft/Music5/5/pyramid_index.txt';
