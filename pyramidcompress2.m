...
% 压缩的对象为信号和时间信息等
% 压缩的依据为信息熵值
read_directory1 = 'dataset/non_orthogonal/topics_data2/采样信号';
read_directory2 = 'D:/Local/workspace/MicroblogDataStreamCompress/dataset/batch_data_segment/topics_data2/entropy';
read_directory3 = 'D:/Local/workspace/MicroblogDataStreamCompress/dataset/batch_data_segment/topics_data2/update_id_time';

write_directory1 = 'dataset/pyramid2/topics_data22/data';
write_directory2 = 'dataset/pyramid2/topics_data22/id_time';
write_directory3 = 'dataset/pyramid2/topics_data22/original_index';
write_directory4 = 'dataset/pyramid2/topics_data22/entropy';
...
% 金字塔压缩索引
write_filename = 'dataset/pyramid2/topics_data22/pyramid_index.txt';
